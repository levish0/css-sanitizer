...
## Current Entries
- [2026-06-26 0.2.0 deny-by-default redesign](2026-06-26-0.2.0-deny-by-default.md) — deny-by-default policy + engine value guard + StrictPolicy + @scope/depth fixes.
